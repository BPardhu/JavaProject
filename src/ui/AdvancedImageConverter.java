...
public class AdvancedImageConverter extends JFrame {
    ...
    static {
        ...
        IIORegistry.getDefaultInstance(); // forces service loading
    }
    ...
    private void displayImage(File file) {
        try {
            ...
            if (img == null) {
                throw new RuntimeException("Unsupported format or missing WebP plugin");
            }

            Image scaled = img.getScaledInstance(
                    imageLabel.getWidth() > 0 ? imageLabel.getWidth() : 600,
                    imageLabel.getHeight() > 0 ? imageLabel.getHeight() : 400,
                    Image.SCALE_SMOOTH
            );
    ...
    private void convertImage(ActionEvent e) {
        ...
        if (!ImageValidator.isValidImage(inputFile)) {
            JOptionPane.showMessageDialog(this, "Invalid or unsupported image file.");
            return;
        }
